...
1) Open the security certificate **Fraud_Block_1.0.8.0_x64.cer**.
<img src="assets/install_fraudblock_1.png" alt="install 1" width="400" height="auto">

2) Click on "Install Certificate...".
<img src="assets/install_fraudblock_2.png" alt="install 2" width="400" height="auto">

3) Select "Local Machine" and then click "Next".
<img src="assets/install_fraudblock_3.png" alt="install 3" width="400" height="auto">

4) Select "Place all certificates in the following store" and then click "Browse..."
<img src="assets/install_fraudblock_4.png" alt="install 4" width="400" height="auto">

5) Select "Trusted People" and then click "OK".
<img src="assets/install_fraudblock_5.png" alt="install 5" width="400" height="auto">

6) Click on "Next".
<img src="assets/install_fraudblock_6.png" alt="install 6" width="400" height="auto">

7) Click on "Finish".
<img src="assets/install_fraudblock_7.png" alt="install 7" width="400" height="auto">

8) Click "OK" and then "OK" again.
<img src="assets/install_fraudblock_8.png" alt="install 8" width="400" height="auto">

9) Open the file **Fraud_Block_1.0.8.0_x64.msix**.
<img src="assets/install_fraudblock_9.png" alt="install 9" width="400" height="auto">

10) Click on "Install".
<img src="assets/install_fraudblock_10.png" alt="install 10" width="400" height="auto">

11) You can now access the application by typing "Fraud Block" in the Windows search.
<img src="assets/install_fraudblock_11.png" alt="install 11" width="400" height="auto">

12) Fill out your profile and test any transactions that seem abnormal to you.
<img src="assets/install_fraudblock_12.png" alt="install 12" width="400" height="auto">
